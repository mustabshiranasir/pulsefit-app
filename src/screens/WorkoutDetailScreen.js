...
import { SafeAreaView, ScrollView, View, Text, StyleSheet, Image, Pressable, Dimensions, Platform, StatusBar } from "react-native";
    ...
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.header}>
          <Image source={{ uri: workout.image }} style={styles.headerImg} />
          <LinearGradient
          ...
          <View style={styles.headerTitleWrap}>
            ...
            <View style={styles.tag}>
                <Text style={styles.tagTxt}>PREMIUM WORKOUT</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.metaRow}>
            <View style={styles.metaItem}>
              <View style={[styles.metaIcon, { backgroundColor: '#FFEDF1' }]}>
                <Ionicons name="time" size={20} color={C.primary} />
              </View>
              <Text style={styles.metaText}>{workout.mins || "15 Min"}</Text>
              <Text style={styles.metaLabel}>Duration</Text>
            </View>
            <View style={styles.metaItem}>
              <View style={[styles.metaIcon, { backgroundColor: '#FFF4E5' }]}>
            ...
            <View style={styles.metaItem}>
              <View style={[styles.metaIcon, { backgroundColor: '#E0F2FE' }]}>
          ...
          <View style={styles.exHeader}>
            ...
            <View style={styles.badge}>
                <Text style={styles.badgeTxt}>{MOCK_EXERCISES.length} Rounds</Text>
            </View>
          </View>

          {MOCK_EXERCISES.map((ex, idx) => (
            <Pressable key={ex.id} style={styles.exerciseCard}>
              <Image source={{ uri: ex.image }} style={styles.exImg} />
              <View style={styles.exInfo}>
                <Text style={styles.exTitle}>{ex.title}</Text>
                <View style={styles.exMetaRow}>
                   <Ionicons name="play-circle-outline" size={14} color={C.primary} />
                   <Text style={styles.exSub}>{ex.duration}</Text>
                   <View style={styles.dot} />
                   <Text style={styles.exSub}>{ex.reps}</Text>
                </View>
              </View>
              <Pressable style={styles.exPlayBtn}>
      ...
      <View style={styles.bottomBar}>
        ...
        >
          ...
          >
            <Text style={styles.startBtnTxt}>Start Training Now</Text>
